...
public class ClienteController {
	...
	public ResponseEntity<List<Cliente>> fetchStudents() {
		try {
			List<Cliente> students = new ArrayList<>();
			students = studentService.findAll();
			return new ResponseEntity<List<Cliente>>(students, HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Cliente> fetchStudent(@PathVariable("id") Integer id) {
		...
		try {
			Optional<Cliente> student = studentService.findById(id);

			if (!student.isPresent()) {
				return new ResponseEntity<Cliente>(HttpStatus.NOT_FOUND);
			}
			return new ResponseEntity<Cliente>(student.get(), HttpStatus.OK);
		} catch (Exception e) {
	...
	public ResponseEntity<Object> save(@Valid @RequestBody Cliente student) {
		try {
	...
	public ResponseEntity<Object> update(@Valid @RequestBody Cliente student) {
		try {
